...
@ComponentScan({ "ch.uzh.ifi.seal.monolith2microservices.controllers", "ch.uzh.ifi.seal.monolith2microservices.main",
        "ch.uzh.ifi.seal.monolith2microservices.services", "ch.uzh.ifi.seal.monolith2microservices.git" })
