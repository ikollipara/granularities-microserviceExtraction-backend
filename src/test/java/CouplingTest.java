...
public class CouplingTest {
    ...
    public void testCombinedCouplings() {
        ...
        // Compute result
        List<BaseCoupling> combinedCouplings = LinearGraphCombination.create()
                .withContributorCouplings(contributorCouplings).withLogicalCouplings(logicalCouplings)
    ...
    public void testCombinedCouplingsWithoutLogical() {
        ...
        // Compute result
        List<BaseCoupling> combinedCouplings = LinearGraphCombination.create()
                .withContributorCouplings(contributorCouplings).withSemanticCouplings(semanticCouplings).generate();
        assertEquals(expectedCouplings, combinedCouplings);
    }
    ...
    public void testLogicalCouplingCombination() {
        ...
        List<BaseCoupling> combinedCouplings = LinearGraphCombination.create().withLogicalCouplings(couplings)
                .generate();
